...
class Settings(BaseSettings):
    ...
    fampay_upi_id: str = Field(default="reflexrohit@fam", alias="FAMPAY_UPI_ID")
    ...
    account_bio: str = Field(default="@TGAccountMarket_Bot", alias="ACCOUNT_BIO")
    required_channel_link: str = Field(default="https://t.me/+kmak6swDLuZlZjg1", alias="REQUIRED_CHANNEL_LINK")
